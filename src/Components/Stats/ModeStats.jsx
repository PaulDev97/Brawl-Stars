    ...
    <div className='flex justify-between items-center  '>
      ...
      <section className='flex flex-col gap-3 '>
        <div className='flex items-center gap-2'>
          ...
          <span className=' text-pink-600 text-lg'>80</span>
        </div>
        <div className='flex items-center gap-2 '>
          <img className='w-[30px] h-[30px]' src="../assets/home/heist.png" alt="" />
          <span className=' text-pink-600 text-lg '>70</span>
        </div>
      </section>
      ...
      <section className='flex flex-col gap-3'>
        <div className='flex items-center gap-2'>
          ...
          <span className=' text-green-400 text-lg'>10</span>
        </div>
        <div className='flex items-center gap-2'>
      ...
      <section className='flex flex-col gap-3'>
        ...
        <img className='w-[32px] h-[30px]' src="../assets/home/mode1.png" alt="" />
          <span className=' text-blue-600 text-lg '>40</span>
        </div>
        <div className='flex items-center gap-2'>
        <img className='w-[28px] h-[26px]' src="../assets/home/robo.png" alt="" />
          <span className='ml-1 text-blue-600 text-lg'>20</span>
        </div>
      </section>
